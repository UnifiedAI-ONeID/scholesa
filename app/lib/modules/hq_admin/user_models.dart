  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    return UserModel(
      ...
      status: UserStatus.values.firstWhere(
        (UserStatus e) => e.name == (json['status'] as String? ?? 'active').toLowerCase(),
        orElse: () => UserStatus.active,
      ),
      siteIds: (json['siteIds'] as List<dynamic>?)?.cast<String>() ?? <String>[],
...
class SiteModel extends Equatable {
  ...
  factory SiteModel.fromJson(Map<String, dynamic> json) {
    return SiteModel(
      ...
      siteLeadIds: (json['siteLeadIds'] as List<dynamic>?)?.cast<String>() ?? <String>[],
      createdAt: DateTime.fromMillisecondsSinceEpoch(json['createdAt'] as int),
